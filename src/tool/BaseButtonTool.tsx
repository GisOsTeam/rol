...
export function withBaseButtonTool(component: string | React.FunctionComponent<IBaseButtonToolProps> | React.ComponentClass<IBaseButtonToolProps, {}>) {
  return class extends BaseButtonTool<IBaseButtonToolProps, {}> {
