...
export function withBaseTool(component: string | React.FunctionComponent<IBaseToolProps> | React.ComponentClass<IBaseToolProps, {}>) {
  return class extends BaseTool<IBaseToolProps, {}> {
    public renderTool(): React.ReactNode {
