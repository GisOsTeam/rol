...
export interface IDraggableListAdaptatorProps<I, C extends IItemComponentProps<I>, T extends DraggableCompoProps<I>> extends pwet<I,C,T> {
    itemComponentProps: any;
}

export function DraggableListAdaptator<I, C extends IItemComponentProps<I>, T extends DraggableCompoProps<I>>(props: IDraggableListAdaptatorProps<I, C, T>) {
    const { items: elements, itemComponent, itemComponentProps } = props;
    return <DraggableList<I, void, T>
        {...itemComponentProps}
        itemKey="uid"
        list={elements}
